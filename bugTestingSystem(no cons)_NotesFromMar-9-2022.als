...
one sig A, B, C, D, E, F extends ReliabilityStatus {}//, Low, Medium, High, VeryHigh 
...
fact reliabilityStatusIfAtleastOneFeature{
//	some system: System | one reliabilityStat2: ReliabilityStatus | reliabilityStat2 in system
//	some system: System | some system.allFeatures implies system.reliabilityStat = 1
	some system2: System | some reliab: ReliabilityStatus | system2.allFeatures > 0 implies system2.reliabilityStatus >0
}
